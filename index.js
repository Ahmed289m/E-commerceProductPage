...
function minuse(){
 ...
 two.addEventListener("click",function(){
    ...
    two.className = "Activ";
    origin.src = "image-product-2.jpg"
 })
 one.addEventListener("click",function(){
    ...
    two.className = " ";
    origin.src = "image-product-1.jpg"
 ...
 three.addEventListener("click",function(){
    ...
    two.className = " ";
    origin.src = "image-product-3.jpg"
 ...
 four.addEventListener("click",function(){
    ...
    two.className = " ";
    origin.src = "image-product-4.jpg"
...
add.addEventListener("click",function(){
   ...
   `
<img width="50px" style="border-radius: 5px;" src="image-product-1-thumbnail.jpg">
